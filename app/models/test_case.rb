  ...
  def register_client!(options = {})
    ...
    if identifier == "b2c-rp-response_type-code"
      client = OpenIDConnect::Client.new(
        ...
        userinfo_endpoint: 'https://uat-account.np.bupaglobal.com/neubgdat01atluat01b2c01.onmicrosoft.com/v2.0/.well-known/openid-configuration?p=b2c_1a_bupa-uni-uat-signinsignup'
      )
